    ...
    return (
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          id={inputId}
          className={cn(
            "h-11 rounded-lg border border-border bg-surface px-3.5 text-[13.5px] text-ink outline-none transition-colors placeholder:text-muted-2 focus:border-primary-light",
            error && "border-danger",
            className,
          )}
          {...props}
