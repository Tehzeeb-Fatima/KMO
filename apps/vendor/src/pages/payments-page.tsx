...
import { getMyVendor, getVendorDueAmount, listVendorPayouts } from "@kmo/shared/api";
  ...
  return (
    <div>
      ...
      <div className="mb-4 flex flex-col gap-3.5 rounded-xl border border-border bg-surface p-6">
        ...
        <input
          placeholder="Amount, e.g. Rs. 400,000"
        ...
        <button
          type="button"
          className="w-fit rounded-lg bg-accent px-4 py-2.5 text-sm font-bold text-white"
        >
